#!/usr/bin/env bash
# ==============================================================================
# Google Cloud SecOps - SCC Standard Tier Deployment Script
# ==============================================================================
# Author: Joabson Saccomani (@jsaccomani)
# Description: Provisions a dedicated Folder and Project with SCC Standard Tier baseline.
# ==============================================================================
...
echo -e "${BOLD}${CYAN}"
echo "=============================================================================="
echo "   GOOGLE CLOUD SECOPS - DEPLOYING SCC STANDARD TIER FOUNDATION"
echo "=============================================================================="
echo -e "${NC}"
...
if [ ! -f "terraform.tfvars" ]; then
  if [ -f "terraform.tfvars.example" ]; then
    ...
    # Auto-detect org/billing if possible
...
read -p "Do you want to proceed with deploying SCC Standard Foundation? (y/N): " -r CONFIRM
if [[ ! "${CONFIRM}" =~ ^[Yy]$ ]]; then
...
echo -e "\n${BOLD}${GREEN}==============================================================================${NC}"
echo -e "${BOLD}${GREEN}   ✅ SCC STANDARD TIER FOUNDATION SUCCESSFULLY DEPLOYED!${NC}"
